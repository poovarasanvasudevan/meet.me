...
const breadcrumbs = (
    <BreadcrumbsStateless onExpand={() => {
        ...
        <BreadcrumbsItem href="#" text="Remote Desktop" key="Remote Desktop" component={RouterLink}/>
...
export default function (props) {
    ...
    const [localMachines, setLocalMachines] = React.useState([]);
