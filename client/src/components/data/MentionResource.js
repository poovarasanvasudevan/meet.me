...
export class MMentionResource extends AbstractMentionResource
    ...
    filter(query: string): void {
        ...
        setTimeout(async () => {
            ...
            for (var i = 0; i < data.length; i++) {
                users.push({
                    ...
                    "avatarUrl": data[i].get('profile').get('avatar').url()
                });
            }
        ...
        //     //         users.push({
        //     //             id : data[i].objectId,
        //     //             name : data[i].get('first_name'),
        //     //             mentionName : data[i].get('first_name'),
        //     //             nickName : data[i].get('first_name'),
        //     //         })
        //     //     }
        //     //
        //     //     notify({
        ...
        //         notifyErrors(parseInt(query, 10) + 'get off my lawn');
        //         return;
        //     } else if (query) {
